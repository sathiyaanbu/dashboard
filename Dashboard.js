...
class Dashboard extends Component {
  ...
  componentDidMount() {
    fetch('http://localhost:8778/api/totalUserCount').then(result => {
      return result.json();
    });
  }
  render() {
        ...
        <div className="container">
          <div>
            ...
            <div className="ac_count">
              <p>{this.state.userAccount_created} </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="active_count">
              <p>{this.state.active_users_count}56</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="msg_count">
              <p>{this.state.message_count}67</p>
            </div>
          </div>
        </div>
            ...
            <Col sm={3}>
              <div className="outer_SideBox">
                <Nav bsStyle="pills" stacked>
                  <NavItem eventKey="first">month</NavItem>
                  <NavItem eventKey="second">year</NavItem>
                  <NavItem eventKey="third">Home</NavItem>
                </Nav>
              </div>
            </Col>
            <Col sm={9}>
